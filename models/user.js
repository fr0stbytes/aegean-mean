...
const emailValidators = [
  ...
  {validator: validEmailChecker, message: 'Email must be in a valid format.'}
]
...
const passwordValidators = [
  ...
  // Second password validator
  {
    ...
    message: 'Must have at least one lowercase character, and number'
  }
];
